...
for i in range(24):
	DATA[i] = 0
ORGID=[0 for i in range(24)]
for i in range(24):
	ORGID[i] = 0
DAYSOFMONTH=[0 for i in range(24)]
for i in range(24):
	DAYSOFMONTH[i] = i+1
...
def appendData():
	...
	DATA_FILENAME ="/var/www/html/json/"+ENVIRONMENT.lower()+".opportunities.last.day.json" 
	...
	new_data = {\
		...
		"yaxistitle": "Opportinities", \
		"xaxistitle": "Hour of the Day" , \
		"legendtitle": {"1": "Opportinities per Hour - "+DAY+" (day of "+MONTH_FMN+") "}, \
		"legenddata": {"1": "Opportinities"}, \
