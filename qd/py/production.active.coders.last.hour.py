...
def appendData():
	global DATA, ORGID, ENVIRONMENT, MONTH_FMN, HOUR, DAY
	DATA_FILENAME ="/var/www/html/json/"+ENVIRONMENT.lower()+".active.coders.last.hour.json" 
	print ("Start writing json data ...\n")

	new_data = {\
		"xaxisdata": {"1": DAYSOFMONTH}, \
		"yaxisdata": {"1": DATA}, \
		"charttitle": ""+ENVIRONMENT.lower()+".active.coders.last.hour", \
		"yaxistitle": "Coders", \
		"xaxistitle": "Minute of the Hour" , \
		"legendtitle": {"1": "Coders per Minute - "+HOUR+" (hour of the day)"}, \
		"legenddata": {"1": "Coders"}, \
