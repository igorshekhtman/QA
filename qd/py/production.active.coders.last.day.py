...
def appendData():
	global DATA, ORGID, ENVIRONMENT, MONTH_FMN, DAY
	DATA_FILENAME ="/var/www/html/json/"+ENVIRONMENT.lower()+".active.coders.last.day.json" 
	...
	new_data = {\
		...
		"legendtitle": {"1": "Coders per Hour - "+DAY+" (day of "+MONTH_FMN+") "}, \
		"legenddata": {"1": "Coders"}, \
