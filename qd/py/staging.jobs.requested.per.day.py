...
def runBaseJobFailed(environment):
	...
	LOGFILE = "summary_coordinator_jobrequest_staging"
...
def appendData():
        JSON_DATA_FILENAME ="/var/www/html/json/"+ENVIRONMENT.lower()+".jobs.requested.per.day.json"
        print ("Start writing json data ...\n")

        new_json_data = { \
                "charttitle": ""+ENVIRONMENT.lower()+".jobs.requested.per.day", \
                "charttype": "line", \
                "dotColor": "black", \
                "dotSize": "4", \
                "updateInterval": "5", \
