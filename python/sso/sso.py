...
# DATE CREATED:    9-Jul-2015
# INITIAL VERSION: 1.0.0
#
# PURPOSE:
#          This program should be executed via Python2.7 for testing SSO functionality:
#
# NOTES / COMMENTS:
...
#=========================================================================================	
def setPasswordPolicy(gid, pname):
	print ("\n----------------------------------------------------------------------------")
	print (">>> UA - SET PW POLICY %s <<<" % pname)
	print ("----------------------------------------------------------------------------")
	response = ""

	URL = "https://useraccount-stg.apixio.com:7076/uorgs/"+gid+"/passwordPolicy/"
	DATA = json.dumps({"passwordPolicy": pname})
	HEADERS = {"Content-Type": "application/json", "Authorization": APIXIO_TOKEN}
	print ("* URL                    = %s" % URL)
	print ("* INTERNAL TOKEN         = %s" % APIXIO_TOKEN)
	print ("* GROUP ID               = %s" % gid)
	print ("* PW POLICY NAME         = %s" % pname)	
	print ("* JSON PAYLOAD DATA      = %s" % DATA)
	#quit()
...
#=========================================================================================
def getInfoForForgetLink(forget_link):
...
def getInternalToken(external_token):
	print "Swapping token: " + external_token
	TOKEN_URL = "https://tokenizer-stg.apixio.com:7075/tokens"
  	...
  	if response.status_code < 400:
  		...
  		print "Error getting internal token"
  		print response.status_code

def getPolicy(internalToken):
	print ""
	...
	user_accounts="https://useraccount-stg.apixio.com:7076/users/me/passpolicy"
  	HEADERS = {'Authorization': 'Apixio ' + internalToken}
...
# groupID, policyName
# setPasswordPolicy("tsog2", "test_sso_policy")

#passwordReminder()

linkInfo= getInfoForForgetLink("V_cd5764d7-c981-457f-a8e2-1e9e45cc88b3")
internalToken = getInternalToken(linkInfo.get("token"))
getPolicy(internalToken)
...
print ("\n============================================================================")	
print ("======================= End of SSO Regression Test =========================")
print ("============================================================================")
#=========================================================================================
