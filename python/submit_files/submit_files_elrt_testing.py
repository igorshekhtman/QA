...
# Uploading 3-page blank document
#
#
...
DIR="/mnt/testdata/ThreeBlankPages/Documents"

# must be the same for all documents to be uploaded to the same patient
#PATIENT_ID="e637168c-5328-11e5-a287-0249c618e111"
...
for FILE in FILES:	
		...
		PATIENT_FIRST_NAME=("ELRT_%s" % (PATIENT_ID))
		#PATIENT_FIRST_NAME=("Verylargepdf")
		#PATIENT_MIDDLE_NAME=("Middlename_%s" % (DOCUMENTCOUNTER))
		PATIENT_MIDDLE_NAME=("M")
		PATIENT_LAST_NAME=("TEST_%s" % (PATIENT_ID))
		#PATIENT_LAST_NAME=("Test")
		PATIENT_DOB="20100101"
		PATIENT_GENDER="M"
		...
		CREATION_DATE="2014-12-12T10:00:47-07:00"
		MODIFIED_DATE="2014-12-12T10:00:47-07:00"
		DESCRIPTION=("%s" % (FILE))
