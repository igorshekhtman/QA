...
# Documents to upload source folder
# ==================================================
#DIR="/mnt/testdata/SanityTwentyDocuments/Documents"
DIR="/mnt/testdata/kelsey/docs/badpdfs"
# ==================================================
...
for FILE in FILES:
		...
		print ("* Document Number:                 %d" % (DOCUMENTCOUNTER))
...
#print ("Total Number of Docs Uploaded:     %d" % (DOCUMENTCOUNTER));
print ("-----------------------------------------------------------")
print ("Total Number of Docs Uploaded:     %d" % (DOCUMENTCOUNTER))
print ("-----------------------------------------------------------")
print ("Closing Batch ...\n")
