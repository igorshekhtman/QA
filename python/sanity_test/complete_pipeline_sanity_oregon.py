...
print "----------------------------------------------------------------"
print "* OPERATION      = OBTAINING TOKEN"
if status_code == 200:
	...
	print "* STATUS CODE    = %s" % status_code
	print "* FAILURE OCCURED, TOKEN COULD NOT BE OBTAINED !!!"
	print "----------------------------------------------------------------"
	quit()
...
def uploadData():
	...
	if status_code == 200:
		...
		print "* STATUS CODE    = %s" % status_code
		print "* UPLOAD URL     = %s" % UPLOAD_URL
		print "* FAILURE OCCURED, FILE COULD NOT BE UPLOADED !!!"
		print "----------------------------------------------------------------"
		quit()
