...
def checkEnvironmentandReceivers():
	...
	if (ENVIRONMENT.upper() == "PRODUCTION"):
		...
		PROTOCOL="https://"
		USERNAME="rthotakura@apixio.com"
		PASSWORD="$200KEarnings"
...
def pushEvent(page):
	...
	URL = DO_URL+"/event"
        ...
        DATA = {
  "subject": {
      "uri": "2b9ce25d-dff0-4d8f-87c0-9cd8f93d7f8b",
      "type": "patient"
  },
  "fact": {
      "code": {
          ...
          "displayName": "Chro kidney dis stage I"
      },
      "time": {
  ...
  "source": {
      "uri": "8f7d6507-117c-4809-a5ff-6df30559d012",
      "type": "document"
  },
  "evidence": {
      "inferred": False,
...
checkEvent("2b9ce25d-dff0-4d8f-87c0-9cd8f93d7f8b")
