...
#=========================================================================================
CSV_CONFIG_FILE_PATH = "/mnt/automation/python/pull_a_document/"
CSV_CONFIG_FILE_NAME = "pulladocument.csv"
VERSION = "1.0.3"
...
def checkEnvironmentandReceivers():
	...
	if (ENVIRONMENT.upper() == "PRODUCTION"):
		...
		AUTH_URL = "https://useraccount.apixio.com:7076/auths"
		TOKEN_URL = "https://tokenizer.apixio.com:7075/tokens"
		DOCUMENT_URL = "https://dataorchestrator-2.apixio.com:7085/document"
		PATIENT_URL = "https://dataorchestrator-2.apixio.com:7085/patient"
		EVENT_URL = "https://dataorchestrator-2.apixio.com:7085/events"
		UTIL_URL = "https://dataorchestrator-2.apixio.com:7085/util"
		DO_URL = "https://dataorchestrator-2.apixio.com:7085"
		PREFIX = "P_"
	else:
...
def getDocument(endpoint, docuuid):
	print ("\n----------------------------------------------------------------------------")
	print (">>> DataOrchestrator - DOCUMENT %s ENDPOINT <<<" % str(endpoint).upper())
	print ("----------------------------------------------------------------------------")
	print ("* DOCUMENT URL 1         = %s" % DOCUMENT_URL)
	
	var_name=PREFIX+"DOC_UUID_"+str(docuuid)
	print var_name
	#value=globals()[var_name]	
	statuscode = 500
	# repeat until successful login is reached
	#while statuscode != 200:
  	url = DOCUMENT_URL+'/'+docuuid+'/'+endpoint
  	referer = DOCUMENT_URL+'/'+docuuid+'/'+endpoint	
	...
	print ("* EXTERNAL TOKEN         = %s" % E_TOKEN)
	print ("* INTERNAL TOKEN         = %s" % I_TOKEN)
	print ("* DOCUMENT UUID          = %s" % docuuid)
	statuscode = response.status_code
	print ("* STATUS CODE            = %s" % statuscode)
	#print response.content
	with open('HCC_724.txt', 'wb') as fd:
...
print ("\n\nStarting Pull a Document from S3...\n")
...
# do a get from data orchestrator /document/{uuid}/file
...
#patient_org_id: "10000347" 
#patient_id: "da21f70a-4650-43be-9cd8-b50aef64bae1" 
#document_uuid: "5950c53c-17da-4170-b30c-4eb16a70eb39"

getDocument("file", "5950c53c-17da-4170-b30c-4eb16a70eb39")
...
print ("====================== End of Pull a Document from S3 ===========================")
print ("=================================================================================")
#=========================================================================================