#=========================================================================================
#========================== configureEventProperties.py ==================================
#=========================================================================================
#
# PROGRAM:         configureEventProperties.py
# AUTHOR:          lschneider
# DATE CREATED:    13-Apr-2015
# INITIAL VERSION: 1.0.0
#
# PURPOSE:
#          This program should be executed via Python2.7 for the purpose of viewing,
#          saving, updating, or deleting of event configuration properties.
#
#=========================================================================================
...
pas_prd = "http://coordinator-prd.apixio.com:8066"

#=========================================================================================

def auth(environment):
    if environment == "production": return auth_prd
    return auth_stg

def tokenizer(environment):
    if environment == "production": return token_prd
    return token_stg
...
def get_environment():
    i = raw_input("\nAre you configuring staging or production? \n>>> ")
...
os.system('clear')
print ("Welcome to the configure event properties tool.\nEnter Q at any time to quit.")
...
available_commands = "\nAvailable commands: list, view, save, update, delete"
i = ""
