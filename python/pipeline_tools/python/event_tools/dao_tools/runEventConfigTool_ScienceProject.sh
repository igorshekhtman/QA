...
#java -cp apixio-datasource-1.5.0.jar:lib/*:$CLASSPATH com.apixio.dao.cmdline.EventConfigTool --redisHost localhost --hdfsDir /user/apxqueue/events --prefix Staging --propertyName ScienceProject $@
