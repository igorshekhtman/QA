...
if [ "$1" = "running" ]
then
    java com.apixio.coordinator.cmdline.JobsInfo --running
elif [ "$1" = "launching" ]
then
    java com.apixio.coordinator.cmdline.JobsInfo --launching
elif [ "$1" = "stats" ]
then
    java com.apixio.coordinator.cmdline.JobsInfo --stats
else
