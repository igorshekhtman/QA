...
if( get_json_object(line, '$.seqfile.file.document.status') != "success", get_json_object(line, '$.message'), null) as error_message,
month,
day,
...
if( get_json_object(line, '$.upload.document.status') != "success", get_json_object(line, '$.message'), null) as error_message,
month,
day,
...
if( get_json_object(line, '$.submit.post.status') != "success", get_json_object(line, '$.message'), null) as error_message,
month,
day,
...
insert overwrite table summary_careopt_errors_staging partition (month, day)
select
get_json_object(line, '$.datestamp') as time,
get_json_object(line, '$.message') as error_message,
get_json_object(line, '$.loggerName') as source,
