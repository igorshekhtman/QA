...
//				System.out.println(status + ": num_docs=" + num_docs + ", num_seq_file=" + num_seq_file);
//			}
//			//log.info(rawQuery("production", "docreceiver", "12/18/2013", "12/19/2013", "EVENT", "", "", "", "", "100"));
		}
		catch (Exception ex) {
	...
	public static String rawQuery(String hiveAddress,
								  ...
								  String endDate, 
								  String level, 
								  String conditionOneObject, 
								  String conditionOneValue, 
								  String conditionTwoObject, 
								  String conditionTwoValue,
								  String limit) throws SQLException, JSONException {

		String tableName = environment + "_logs_" + getComponentTableName(component) + "_epoch";
